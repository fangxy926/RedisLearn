package com.example.redislearn.rankingboard.util;
...
public class DateUtil {
    ...
    public static Long getWeekEndTime(Long timeStamp, String timeZone) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeInMillis(getWeekStartTime(timeStamp, timeZone));
    ...
    public static void main(String[] args) {
        ...
        Long weekStart = getWeekStartTime(currentTime, "GMT+8:00");
        Long weekEnd = getWeekEndTime(currentTime, "GMT+8:00");
